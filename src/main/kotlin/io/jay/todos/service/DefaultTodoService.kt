...
class DefaultTodoService(private val todoRepository: TodoRepository) : TodoService {
    ...
    override fun updateDescription(id: Int, updateTodoRequest: UpdateTodoRequest): Todo? {
        val existing = todoRepository.findById(id) ?: return null
        return todoRepository.update(id, Todo(id, updateTodoRequest.description, existing.finished))
    }
}
