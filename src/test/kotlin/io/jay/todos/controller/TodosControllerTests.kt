...
class TodosControllerTests {
    ...
    @Nested
    inner class UpdateTodoDescription {
        ...
        fun `should return 200 OK when todo exists`() {
            every { mockTodoService.updateDescription(1, updateTodoRequest) } returns Todo(1, "Updated description", false)
        ...
        fun `should return 404 NOT FOUND when todo does not exist`() {
            every { mockTodoService.updateDescription(1, updateTodoRequest) } returns null
        ...
        fun `should call todoService`() {
            ...
            verify { mockTodoService.updateDescription(1, updateTodoRequest) }
        }
